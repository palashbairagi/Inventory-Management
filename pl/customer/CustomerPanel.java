...
public boolean validate(CustomerUI customerUI)
{
if(InputValidator.isTextFieldEmpty(customerUI,name,"Name required",true))return false;
if(InputValidator.isTextFieldEmpty(customerUI,openingBalance,"Opening Balance required",true))return false;
return true;
}
